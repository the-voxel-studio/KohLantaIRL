...
async def join(message):
    ...
    if (
        ...
        embed = discord.Embed(
            ...
            description=f":warning: La partie a déjà débutée",
            color=COLOR_ORANGE,
        )
        ...
        embed = discord.Embed(
            title=f":robot: Action inutile :moyai:",
            description=f":white_check_mark: Vous êtes déjà inscrit à cette partie.",
            color=COLOR_GREEN,
        )
        ...
        embed = discord.Embed(
            title=f":robot: Action impossible :moyai:",
            description=f":warning: Vous devez renseigner votre prénom et initiale de nom comme suis : `Prénom N`\nDe plus, le prénom ne peut contenir d'espaces. Si besoin, utilisez des *-* .",
            color=COLOR_ORANGE,
        )
        await player.send(embed=embed)
    else:
        ...
        try:
            ...
            embed = discord.Embed(
                title=f":robot: Faible erreur :moyai:",
