        ...
        if isinstance(interaction.channel, discord.DMChannel):
            ...
            if is_last_eliminate and not_timeout:
                ...
                if not eliminated.last_wish_expressed:
                    ...
                    embed = discord.Embed(
                        title=f":robot: Commande verrouillée :moyai:",
                        description=f":no_entry: Cette commande a déjà été utilisée.\n\nCommande : /dv",
                        color=COLOR_ORANGE,
                    )
                    embed.set_footer(
            ...
            embed = discord.Embed(
                title=f":robot: Commande privée :moyai:",
                description=f":no_entry: Cette commande est seulement disponible en message privé.\n\nCommande : /dv",
                color=COLOR_ORANGE,
            )
            embed.set_footer(
                text=f"Essayer à plusieurs reprises d'utiliser une commande interdite ou y parvenir sans autorisation des administrateurs entrainera systématiquement un bannissement temporaire ou définitif du joueur."
